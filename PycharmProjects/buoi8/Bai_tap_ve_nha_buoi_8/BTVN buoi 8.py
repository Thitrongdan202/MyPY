class NhanVien:
    ...
    def __str__(self):
        return "NV: " + str([self._ma_nv, self._ho_ten, self._luong_cb, self._luong_ht])
...
class NVVP(NhanVien):
    ...
    def tinh_luong_ht(self):
        self._luong_ht = self._luong_cb + self.__so_ng * 150_000
...
class NVBH(NhanVien):
    ...
    def __str__(self):
        return "NVBH: " + str([self._ma_nv, self._ho_ten, self._luong_cb, self._luong_ht, self.__so_sp])

    def tinh_luong_ht(self):
        self._luong_ht = self._luong_cb + self.__so_sp * 18_000
